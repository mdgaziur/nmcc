...
// TODO: make it create diagnostic once we finish implementing diagnostics
// handling
#define __STRINGIFY_INNER(x) #x
#define STRINGIFY(x) __STRINGIFY_INNER(x)
#define ERR(...)                                                               \
  fprintf(stderr, DIAG_CERROR                                                  \
          "error at line: " STRINGIFY(__LINE__) ", file: " __FILE__            \
...
Diagnostic *diagnostic_for_single_char(DiagKind diag_kind, NMFile *file,
